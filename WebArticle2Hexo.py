...
+-----------------------------------------------------------------+
|                                                                 |
|  抓取网址 |__________________________________________________|   |
|  代理设置 |__________________________________________________|   |
|  抓取标签 |____| 标签属性 |____| 属性参数 |____|  [] 输出转载信息  |
|                                                                 |
|   |<===================输出 Markdwon 文件===================>|   |
|   |<=====================输出 HTML 文件=====================>|   |
+-----------------------------------------------------------------+
...
抓取网址                        输入 文章url
代理设置                        用于访问外网
抓取标签 标签属性 属性参数       用来指定抓取网页的位置
输出转载信息                    输出 hexo Markdown 的头文件
"""
# NOTE Python2 coding
# import urllib2
